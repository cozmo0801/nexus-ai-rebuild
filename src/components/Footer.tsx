            ...
            <div className="max-w-2xl mx-auto text-center">
              ...
              <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
                ...
                <Button
                  ...
                  className="bg-gradient-to-r from-accent-purple to-accent-teal text-white font-semibold px-6 py-2 rounded-xl hover:shadow-glow transition-all duration-300 hover:-translate-y-1 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isSubscribing ? (
            ...
            <div className="bg-gradient-to-r from-accent-purple/10 to-accent-teal/10 border border-accent-purple/20 rounded-2xl p-6 text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                <Button
                  ...
                  className="bg-gradient-to-r from-accent-purple to-accent-teal text-white font-semibold hover:shadow-glow transition-all duration-300 hover:-translate-y-1"
                >
                  Start Free Trial
                </Button>
                <Button
