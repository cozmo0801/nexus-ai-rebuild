            ...
            <Sheet>
              <SheetTrigger asChild>
                <button
                  ...
                  className="md:hidden p-2 rounded-lg glass-card border-glass"
                >
              ...
              <SheetContent side="right" className="w-full sm:max-w-xs">
                <div className="flex flex-col gap-4 mt-8">
                  <SheetClose asChild>
                    <Link to="/" className="text-lg" aria-label="Home">
                      Home
                    </Link>
                  </SheetClose>
                  <SheetClose asChild>
                    <Link to="/solutions" className="text-lg" aria-label="Solutions">
                      Solutions
                    </Link>
                  </SheetClose>
                  <SheetClose asChild>
                    <Link to="/contact" className="text-lg" aria-label="Contact">
                      Contact
                    </Link>
                  </SheetClose>
                  <SheetClose asChild>
                    <Link to="/faq" className="text-lg" aria-label="FAQ">
                      FAQ
                    </Link>
                  </SheetClose>
                  <Button
